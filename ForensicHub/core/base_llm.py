...
class BaseLLM:
    ...
    def build_messages(self, image: str) -> Dict[str, Any]:
        ...
        Returns:
            Dict[str, Any]: Dictionary of messages for the model.
        """
        return [
            {
                "role": "user",
                "content": [
                    ...
                    {
                        "type": "text",
                        "text": "You have been shown one image, which might be taken from real world or generated by an advanced AI model. \nIs this image taken from the real world or AI-generated? (Answer real if you think it is taken from the real world, and answer fake if you think it is generated by an advanced AI model or edited.). Your output must be real or fake only."
                    }
                ]
            }
        ]
    ...
    def init_model(self, model_path: str, **kwargs):
